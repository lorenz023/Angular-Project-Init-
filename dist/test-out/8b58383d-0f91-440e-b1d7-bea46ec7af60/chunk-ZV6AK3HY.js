...
var urlParse, MOCK_PLATFORM_LOCATION_CONFIG, MockPlatformLocation, FakeNavigationPlatformLocation, FAKE_NAVIGATION, SpyLocation, LocationState, MockLocationStrategy, _MockPopStateEvent;
var init_testing2 = __esm({
  "node_modules/@angular/common/fesm2022/testing.mjs"() {
    ...
    MockPlatformLocation = class _MockPlatformLocation {
      baseHref = "";
    ...
    FakeNavigationPlatformLocation = class _FakeNavigationPlatformLocation {
      _platformNavigation;
      constructor() {
    ...
    FAKE_NAVIGATION = new InjectionToken("fakeNavigation", {
      providedIn: "root",
      factory: () => {
    ...
    SpyLocation = class _SpyLocation {
      urlChanges = [];
    ...
    MockLocationStrategy = class _MockLocationStrategy extends LocationStrategy {
      internalBaseHref = "/";
      internalPath = "/";
      internalTitle = "";
      urlChanges = [];
...
@angular/common/fesm2022/testing.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZV6AK3HY.js.map

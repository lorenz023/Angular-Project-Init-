...
var init_app_component = __esm({
  "angular:jit:template:src/app/app.component.html"() {
    app_component_default = '<h1>Hello, angular-sample-small-project</h1>\n\n<span>\n  <strong>\n    sample\n  </strong>\n  for\n  <strong>\n    small\n  </strong>\n  projects\n</span>\n\n<button routerLink="/sample" style="margin-bottom: 10px; margin-left: 5px;">\n  Go To Sample Component\n</button>\n\n<div style="border-top: 1px solid #525252;">\n  <router-outlet></router-outlet>\n</div>\n';
  }
});
...
var require_app_component_spec = __commonJS({
  "src/app/app.component.spec.ts"(exports) {
    ...
    describe("AppComponent", () => {
      ...
      it(`should have the 'angular-sample-small-project' title`, () => {
        const fixture = TestBed.createComponent(AppComponent);
        const app = fixture.componentInstance;
        expect(app.title).toEqual("angular-sample-small-project");
      });
      it("should render title", () => {
        const fixture = TestBed.createComponent(AppComponent);
        fixture.detectChanges();
        const compiled = fixture.nativeElement;
        expect(compiled.querySelector("h1")?.textContent).toContain("Hello, angular-sample-small-project");
      });
    });
  }
});
